...
function libraryGenerator(tree, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const libsDir = layoutDirectory !== null && layoutDirectory !== void 0 ? layoutDirectory : (0, devkit_1.getWorkspaceLayout)(tree).libsDir;
...
function projectGenerator(tree, schema, destinationDir, filesDir) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const tasks = [];
        tasks.push(yield (0, init_1.default)(tree, Object.assign(Object.assign({}, schema), { skipFormat: true })));
        ...
        if (!schema.skipTsConfig) {
            (0, ts_config_1.updateRootTsConfig)(tree, options);
        }
    ...
    if (options.buildable && options.config !== 'npm-scripts') {
        ...
        projectConfiguration.targets.build = {
            ...
            options: {
                ...
                assets: options.bundler === 'rollup' ? [] : [`${options.projectRoot}/*.md`],
            },
        };
        if (options.bundler === 'rollup') {
...
function createFiles(tree, options, filesDir) {
    ...
    (0, devkit_1.generateFiles)(tree, filesDir, options.projectRoot, Object.assign(Object.assign({}, options), { dot: '.', className,
        name,
        propertyName, js: !!options.js, cliCommand: 'nx', strict: undefined, tmpl: '', offsetFromRoot: (0, devkit_1.offsetFromRoot)(options.projectRoot), rootTsConfigPath: (0, ts_config_1.getRelativePathToRootTsConfig)(tree, options.projectRoot), buildable: options.buildable === true, hasUnitTestRunner: options.unitTestRunner !== 'none' }));
    if (options.compiler === 'swc') {
        (0, add_swc_dependencies_1.addSwcDependencies)(tree);
        (0, add_swc_config_1.addSwcConfig)(tree, options.projectRoot, options.bundler === 'rollup' ? 'es6' : 'commonjs');
    }
...
function addJest(tree, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return yield jestProjectGenerator(tree, Object.assign(Object.assign({}, options), { project: options.name, setupFile: 'none', supportTsx: false, skipSerializers: true, testEnvironment: options.testEnvironment, skipFormat: true, compiler: options.compiler }));
    });
}
