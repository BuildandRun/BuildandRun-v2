          ...
          <ul className="social-icon">
            <li className="social-icon__item">
              <a
                ...
                href="https://www.crunchbase.com/organization/brstoreus"
                target="_blank"
              >
            ...
            <li className="social-icon__item">
              <a
                className="social-icon__link"
                href="https://stackshare.io/build-and-run/build-and-run"
                target="_blank"
              >
                <div className="social-bar2">
            ...
            <li className="social-icon__item">
              <a
                className="social-icon__link"
                href="https://angel.co/company/bandr"
                target="_blank"
              >
                <div className="social-bar2">
          ...
          <footer className="footer">
            <ul className="social-icon">
              ...
              <li className="social-icon__item">
                <a
                  className="social-icon__link"
                  href="https://discord.gg/HVB2XNFtCQ"
                  target="_blank"
                >
                  <div className="social-bar2">
            ...
            >
              <img
                ...
                alt="Build&#0032;and&#0032;Run - &#0035;web&#0032;&#0035;development&#0032;&#0035;website&#0032;&#0035;webdesign&#0032;&#0035;hosting&#0032;&#0035;tweaks&#0032; | Product Hunt"
                width="150"
                height="54"
              />
            </a>
