      ...
      <p id="love">
        ...
        <footer className="footer">
          ...
          <ul className="menu">
            ...
            <li className="menu__item"><a className="menu__link" href="https://support.brstore.us/privacy.php" target="_blank">Privacy Policy</a></li>
            <li className="menu__item"><a className="menu__link" href="https://support.brstore.us/terms.php" target="_blank">Terms Of Service</a></li>
