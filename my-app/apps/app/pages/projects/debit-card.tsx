    ...
    <div>
      ...
      <div className="company-text" id="company-text-1">
        <div className="blank-payment-successful">
          <div>
            <span>Use this tool for all your <a className="free-trials">Free Trials</a></span>
            <div className="debit-update-icon">
              <a href="https://free.timeanddate.com/countdown/i8qut7vg/n70/cf100/cm0/cu4/ct0/cs0/ca0/co0/cr0/ss0/cac000/cpc000/pct/tcfff/fs100/szw192/szh81/iso2023-03-30T00:00:00" target="_blank">
            ...
            <div className="debit-card-object">
              <div className="debit-flip-card">
                <div className="debit-flip-card-inner">
                  <div className="debit-flip-card-front">
                    ...
                    <svg viewBox="0 0 48 48" height="36" width="36" y="0px" x="0px" xmlns="http://www.w3.org/2000/svg" className="debit-logo">
                    ...
                    <svg xmlSpace="preserve" viewBox="0 0 50 50" height="30px" width="30px" y="0px" x="0px" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" className="debit-chip" version="1.1">  <image href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAMAAAAp4XiDAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
              ...
              LTEzVDA4OjE1OjI5KzAwOjAwY2+u1gAAAABJRU5ErkJggg==" y="0" x="0" height="50" width="50" id="image0"></image>
                    ...
                    <svg xmlSpace="preserve" viewBox="0 0 50 50" height="20px" width="20px" y="0px" x="0px" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" className="debit-contactless" version="1.1">  <image href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAQAAAC0NkA6AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
          ...
          <input type="button" onClick={() => { const address = "Main Street, Dallas Texas 75202"; alert(`Address: ${address}`); }} value="Display Address" ></input>
          </div>
